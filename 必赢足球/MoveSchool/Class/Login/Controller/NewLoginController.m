...
- (void) setUpRegistView
{
    ...
    NSString *allString = @"我已经阅读并同意《网易足球用户协议》";
    NSMutableAttributedString *string = [[NSMutableAttributedString alloc] initWithString:allString];
    [string addAttribute:NSForegroundColorAttributeName value:MainColor range:[allString rangeOfString:@"《网易足球用户协议》"]];
